...
$footer_class = "2";
$footer_margin_class = anps_header_margin();

$footer_style = get_option('anps_footer_style', '1');
...
<footer class="site-footer <?php echo esc_attr($footer_style_class);?> <?php echo esc_attr($footer_margin_class);?>">
    <?php if($prefooter=="on") : ?>
    <div class="container">
        <div class="row">
