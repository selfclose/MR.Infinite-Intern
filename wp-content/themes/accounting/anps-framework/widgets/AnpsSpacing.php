...
class AnpsSpacing extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'AnpsSpacings', esc_html__('AnpsThemes - Spacing'), array('description' => esc_html__('Add extra white space', 'accounting'))
        );
    }
    ...
    function form($instance) {
        ...
        ?>
        <p class="anps-widget-spacing-input"><?php esc_html_e('Add empty space height', 'accounting'); ?>
