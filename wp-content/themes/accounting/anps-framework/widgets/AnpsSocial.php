...
class AnpsSocial extends WP_Widget {
    public function __construct() {
        parent::__construct(
                'AnpsSocial', __('AnpsThemes - Social icons', 'accounting'), array('description' => __('Enter social icons to show on page', 'accounting'),)
        );
    ...
    function form($instance) {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('sidebar_content')); ?>"><?php _e("Sidebar content", 'accounting'); ?></label>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id('target')); ?>"><?php _e("Target", 'accounting'); ?></label>
        ...
        <div style="display: none;">
            ...
            <div class="anps-iconpicker">
                ...
                <button type="button"><?php _e('Select icon', 'accounting'); ?></button>
            </div>
        </div>
    ...
    function widget($args, $instance) {
        ...
        <ul class="<?php echo esc_attr($class); ?>">
            ...
            <li>
                ...
                <?php else : ?>
                <span class="fa <?php echo $social_icon; ?>"<?php if(isset($instance['icon_color'])&&$instance['icon_color']!=''):?> style="color: <?php echo esc_attr($instance['icon_color']);?>"<?php endif; ?>></span>
                <?php endif; ?>
            </li>
            <?php endforeach; ?>
        </ul>
