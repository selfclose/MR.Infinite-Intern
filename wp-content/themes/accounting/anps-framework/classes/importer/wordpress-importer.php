...
class WP_Import extends WP_Importer { 
	...
	function import_end() {
		...
		echo '<h2 style="text-align:center;">' . __( 'All done.', 'wordpress-importer' ) . ' <a href="' . admin_url() . '">' . __( 'Have fun!', 'wordpress-importer' ) . '</a>' . '</h2>';

		echo '<h2 style="text-align:center;">' . __( 'Remember to update the passwords and roles of imported users.', 'wordpress-importer' ) . '</h2>';
