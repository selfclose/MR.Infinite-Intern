...
if (isset($_GET['save_media'])) {
    if( !isset($_POST['auto_adjust_logo']) && $_POST['auto_adjust_logo'] != 'on' ) {
...
<form action="themes.php?page=theme_options&sub_page=options_media&save_media" method="post">
    <div class="content-top"><input type="submit" value="<?php esc_html_e('Save all changes', 'accounting'); ?>" /><div class="clear"></div></div>
    <div class="content-inner">
        <h3><?php esc_html_e('Heading background:', 'accounting'); ?></h3>
        <!-- Heading background -->
        <div class="input floatleft onehalf anps_upload">
            <label for="anps_heading_bg"><?php esc_html_e('Page heading background', 'accounting'); ?></label>
            ...
            <p class="fullwidth"><?php esc_html_e('Enter an URL or upload an image for the page heading background.', 'accounting'); ?></p>
            <div class="clear"></div>
        </div>
        <!-- Search heading background -->
        <div class="input onehalf anps_upload">
            <label for="anps_search_heading_bg"><?php esc_html_e('Search page heading background', 'accounting'); ?></label>
            ...
            <input id="_btn" class="upload_image_button" type="button" value="Upload" />
            <p class="fullwidth"><?php esc_html_e('Enter an URL or upload an image for the search page heading background.', 'accounting'); ?></p>
            <div class="clear"></div>
        </div>
        <hr>
        <h3><?php esc_html_e('Favicon and logo:', 'accounting'); ?></h3>
        <p><?php esc_html_e('If you would like to use your logo and favicon, upload them to your theme here.', 'accounting'); ?></p>

        <!-- Logo -->
        <div class="input onehalf floatleft anps_upload">
            <label for="anps_logo"><?php esc_html_e('Logo', 'accounting'); ?></label>
            <?php
                $logo_width = 158;
                $logo_height = 33;
                $anps_logo_width = anps_get_option($anps_media_data, 'logo_width');
                $anps_logo_height = anps_get_option($anps_media_data, 'logo_height');
                if(isset($anps_logo_width) && $anps_logo_width!='') {
                    $logo_width = anps_get_option($anps_media_data, 'logo_width');
                }
                
                if(isset($anps_logo_height) && $anps_logo_height!='') {
                    $logo_height = anps_get_option($anps_media_data, 'logo_height');
                }
        ...
        <?php endif; ?>
            ...
            <input id="_btn" class="upload_image_button" type="button" value="Upload" />
            <p class="fullwidth"><?php esc_html_e('Enter an URL or upload an image for the logo.', 'accounting'); ?></p>
            ...
            <div class="input fullwidth" style="min-height:0;">
                ...
                ?>
                <label class="onehalf floatleft" for="auto_adjust_logo"><?php esc_html_e('Auto adjust logo size?', 'accounting'); ?></label>
            ...
            <div class="input onehalf floatleft first addspace onoff">
                <label for="logo-width"><?php esc_html_e('Logo width', 'accounting'); ?></label>
                <input style="width: 100px;" id="logo-width" type="text" name="anps_logo_width" value="<?php echo esc_attr($logo_width); ?>" /> <span class="unit">px</span>
            </div>

            <div class="input onehalf floatleft last addspace onoff">
                <label for="logo-height"><?php esc_html_e('Logo height', 'accounting'); ?></label>
                <input style="width: 100px;" id="logo-height" type="text" name="anps_logo_height" value="<?php echo esc_attr($logo_height); ?>" /> <span class="unit">px</span>
            </div>
        </div>
        <!-- Sticky logo -->
        <div class="input onehalf stickylogo anps_upload">
            <label for="anps_sticky_logo"><?php esc_html_e('Sticky logo', 'accounting'); ?></label>
        ...
        <!-- Favicon -->
        <div class="input onehalf anps_upload">
            <label for="anps_favicon"><?php esc_html_e('Favicon', 'accounting'); ?></label>
            ...
            <input id="_btn" class="upload_image_button" type="button" value="Upload" />
            <p class="fullwidth"><?php esc_html_e('Enter an URL or upload an image for the favicon.', 'accounting'); ?></p>
            <div class="clear"></div>
        </div>
        <div class="clear"></div>
