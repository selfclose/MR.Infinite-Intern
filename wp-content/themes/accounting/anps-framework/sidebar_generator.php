		...
		<div class="wrap">
			...
			<table class="widefat page" id="sbg_table" style="width:600px;">
				...
				<tr class="<?php echo esc_attr($alt);?>">
					...
					<td><?php echo sidebar_generator::name_to_class(esc_html($sidebar)); ?></td>

					<td><a href="#" onclick="return remove_sidebar_link('<?php echo esc_js($sidebar); ?>',<?php echo esc_js($cnt+1); ?>);" title="Remove this sidebar">remove</a></td>
		...
		<div id="sbg_box" class="postbox " >
			...
			<div class="inside">
				...
				<div class="sbg_container">
					...
					<p>
						<?php _e( 'Select the sidebar you wish to display. If no value is selected, then the global sidebar will be used. Any other value will overwrite the global option. Use "None" to remove the global sidebar for on a specific post/page.', 'accounting' ); ?>
					...
					<?php 
						...
						for($i=0;$i<1;$i++) { ?>
							...
							<li><?php _e("Left", 'accounting'); ?>:

							<select name="sidebar_generator">
								<option value="0"></option>
								<option value="-1"<?php if($selected_sidebar[$i] == '-1'){ echo " selected";} ?>><?php _e("None", 'accounting'); ?></option>
							...
							<?php _e("Right", 'accounting'); ?>: 

							<select name="sidebar_generator_replacement">
								<option value="0"></option>
								<option value="-1"<?php if($selected_sidebar_replacement[$i] == '-1'){ echo " selected";} ?>><?php _e("None", 'accounting'); ?></option>
